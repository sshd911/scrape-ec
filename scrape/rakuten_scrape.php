...
$url1  = (string) filter_input(INPUT_GET, "url1");
...
echo "<p class='fw-bolder'>Rakuten簡単検索の結果【売れ筋ランキング】</p>";
...
echo "</table>";
unset($dom, $url, $url1, $xpath, $k, $i, $count, $title, $href, $rakuten_arr, $title_arr, $href_arr, $v);
